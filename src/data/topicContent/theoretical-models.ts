...
export const theoreticalModels: DetailedTopicContent = {
  ...
  introduction: [
    'Disability can be understood in many different ways depending on which perspective or framework is applied. These frameworks are called <strong>theoretical models of disability</strong>, and they shape how societies define disability, identify what causes barriers, and determine how to respond. Some models place the focus on the individual and their medical condition, while others emphasize the social and environmental factors that create exclusion. For CPACC certification candidates, understanding these models is essential because they form the conceptual foundation for accessibility standards, anti-discrimination legislation, and inclusive design practices worldwide.',
    'No single model captures the full complexity of disability. Each framework highlights certain aspects while overlooking others. In professional accessibility work, practitioners draw on multiple models simultaneously to address the biological, psychological, social, and environmental dimensions of disability. The CPACC Body of Knowledge covers seven major models, and the exam expects candidates to compare their assumptions, recognize their limitations, and apply the most appropriate model to a given situation. Developing this analytical skill prepares you to make well-informed decisions that balance medical needs, social inclusion, and practical problem-solving.',
  ],
  learningPoints: [
    ...
    'Evaluate which model best fits a given accessibility scenario and justify that choice.',
  ],
  sections: [
    {
    ...
    },
    {
      ...
      content: [
        'This model tries to be the middle ground. It combines the medical and social models into one big picture. It looks at biological factors—meaning health—psychological factors—meaning how we think and feel—and social factors—meaning our environment and relationships.',
        'In 1977, psychiatrist George Engel proposed the biopsychosocial model. In 2001, the <strong>World Health Organization</strong> adopted this approach when it published the <strong>International Classification of Functioning, Disability and Health (ICF)</strong>.',
