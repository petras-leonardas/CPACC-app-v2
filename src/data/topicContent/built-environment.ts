...
export const builtEnvironment: DetailedTopicContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        'Most countries have laws that set "minimum standards" for buildings. These are like the "C-minus" of design—it is the least you can do to avoid breaking the law. Often, these laws focus on reasonable accommodations, which are specific changes made for one person\'s needs.',
        'While these rules are important, they usually do not go far enough. Universal design aims for the "A-plus." It goes beyond the legal minimum to create spaces that are actually welcoming and comfortable for everyone to use, rather than just technically "legal."',
      ],
    },
    {
