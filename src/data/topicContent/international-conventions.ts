...
export const internationalConventions: DetailedTopicContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      subsections: [
        {
          heading: 'Overview and global adoption',
          content: 'The Convention on the Rights of Persons with Disabilities represents a major shift in how disability is understood in international law. Adopted by the United Nations in 2006, it was developed in response to the absence of a legally binding treaty that explicitly protected the rights of people with disabilities. The Convention has been widely embraced globally, with over 160 countries and regional integration organizations signing and more than 180 ratifying it. It now serves as the basis and reference point for national disability rights instruments and measures in states parties around the world.<br/><br/>The CRPD moves away from viewing disabled people as objects of charity or medical care. Instead, it recognizes them as rights-holders who can make decisions about their own lives and participate fully in society. The Convention adopts a broad understanding of disability and reaffirms that all persons with all types of disabilities must enjoy all human rights and fundamental freedoms. It clarifies how all categories of rights apply to persons with disabilities and identifies areas where adaptations must be made for persons with disabilities to effectively exercise their rights.'
        },
        {
          heading: 'Accessibility at the core',
          content: 'A key feature of the CRPD is that it is legally binding for countries that ratify it. States are not only expected to recognize rights, but also to take concrete steps to implement them. This includes changing laws, policies, and practices that create or maintain barriers.<br/><br/>Accessibility is a central concept within the CRPD. It is established as a general principle in <strong>Article 3</strong> and detailed extensively in <strong>Article 9</strong>. The Convention recognizes "the importance of accessibility to the physical, social, economic and cultural environment, to health and education and to information and communication, in enabling persons with disabilities to fully enjoy all human rights and fundamental freedoms." Article 9 requires states parties to ensure access on an equal basis to the physical environment, transportation, information and communications (including information and communications technologies and systems), and other facilities and services open or provided to the public, both in urban and rural areas.'
        },
        {
          heading: 'Required accessibility measures',
          content: [
            'The CRPD outlines concrete measures that states parties must take to achieve accessibility:<ul class="list-disc ml-6 mt-2 space-y-1"><li>Ensuring access to buildings, roads, transportation, schools, housing, medical facilities, workplaces, and emergency services</li><li>Developing minimum standards and guidelines for accessibility of facilities and services</li><li>Ensuring private entities that offer public facilities and services account for accessibility</li><li>Providing training for stakeholders on accessibility issues</li><li>Providing signage in Braille and easy-to-read forms in public buildings</li><li>Offering live assistance through guides, readers, and professional sign language interpreters</li><li>Promoting accessible information and communications technologies from the early design stage so they become accessible at minimum cost</li></ul>'
          ]
        },
        {
          heading: 'Monitoring and accountability',
          content: 'The CRPD establishes an international monitoring process to ensure implementation. The Committee on the Rights of Persons with Disabilities regularly reviews how states parties are implementing the Convention. As part of this review, the Committee compiles a List of Issues based on written input from non-governmental organizations (NGOs), particularly those representing people with disabilities. States parties must report on their progress in response to these issues, and NGOs can submit alternative reports to provide independent perspectives. This process reinforces accountability and ensures that disabled people\'s voices are central to evaluating how rights are implemented.'
        }
      ]
    },
    {
