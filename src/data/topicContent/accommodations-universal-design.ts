  ...
  sections: [
    {
      ...
      content: [
        ...
        'Think of it like this:<ul class="list-disc ml-6 mt-2 space-y-1"><li>Universal design is building a beautiful, wide ramp next to the stairs so everyone can enter the building together.</li><li>Accommodations are like having to call someone to bring out a portable lift because the stairs are the only way in.</li></ul>',
