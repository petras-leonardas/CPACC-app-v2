  ...
  sections: [
    {
      ...
      content: [
        ...
        '<strong>Reasonable accommodation</strong> is a different approach. It involves individualized adjustments made for a specific person in a specific situation to ensure they are not excluded. The concept of reasonable accommodation appears in many disability rights laws, including the Americans with Disabilities Act and the UN Convention on the Rights of Persons with Disabilities. Organizations must provide these adjustments unless doing so would impose an undue or disproportionate burden.',
