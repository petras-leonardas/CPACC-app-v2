...
export const universalDesignPrinciples: DetailedTopicContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: 'The big goal here is to make the world a more independent place. When we follow these rules, we create environments that are a pleasure for everyone to use. It reduces the need for expensive <strong>retrofits</strong> later on and makes sure everyone can join the party from day one.'
    }
  ]
}
