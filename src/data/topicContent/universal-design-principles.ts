...
export const universalDesignPrinciples: DetailedTopicContent = {
  ...
  introduction: [
    ...
    'These principles were created in 1997 by a team led by Ronald Mace at North Carolina State University. They help us move away from a "one-size-fits-all" mindset and toward a "one-size-fits-most" reality that celebrates human diversity.',
  ],
  learningPoints: [
