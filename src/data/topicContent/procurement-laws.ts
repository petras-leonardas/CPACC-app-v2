...
export const procurementLaws: DetailedTopicContent = {
  ...
  learningPoints: [
    'Identify the most important accessibility laws that focus on specific industries.',
    'Understand why certain sectors require their own specialized accessibility regulations.',
    'Explain the objectives and beneficiaries of domain-specific accessibility legislation.',
    'Recognize how government procurement policies serve as mechanisms for advancing accessibility standards.',
  ],
  sections: [
    {
    ...
    },
    {
      ...
      content: [
        'The <strong>Air Carrier Access Act</strong> is a law from 1986 that makes it illegal for airlines to discriminate against people because of a disability. It covers everything from getting help boarding a plane to making sure that wheelchairs are handled with care. Various legislative proposals have been introduced over the years to strengthen these protections, though the original 1986 Act remains the primary law.',
