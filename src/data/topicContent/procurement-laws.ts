...
export const procurementLaws: DetailedTopicContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        'The Twenty-First Century Communications and Video Accessibility Act (or CVAA) is a major law from October 8, 2010, that brought U.S. communication rules into the modern age. It makes sure that as we move from old-fashioned landlines to internet calls and streaming video, people with disabilities have the same access to these tools as everyone else. This law ensures that the "latest and greatest" tech is also the most inclusive.',
        'In Europe, the Audiovisual Media Services Directive (or AVMSD) does something similar for television and online video. This directive is a set of guidelines that tells media companies in the European Union they need to keep getting better at offering things like captions and sign language. This means that more people can enjoy their favorite shows and stay informed during emergencies.',
      ],
    },
    {
      heading: 'Transportation accessibility',
      content: [
        'The Air Carrier Access Act is a law from 1986 that makes it illegal for airlines to discriminate against people because of a disability. It was later supported by the Air Carrier Access Amendments Act of 2017, which helped make sure the rules kept up with how we travel today. These laws cover everything from getting help boarding a plane to making sure that wheelchairs are handled with care.',
    ...
    },
    {
      ...
      content: [
        'The European Electronic Communications Code is a big set of rules that governs how phone and internet services work across Europe. One of its main jobs is making sure that people with disabilities can get help when they need it most. This code requires that emergency services be easy to reach for everyone, regardless of how they communicate.',
    ...
    },
    {
      ...
      content: [
        ...
        'The EU Public Procurement Directive is a set of rules that tells public offices across Europe they must think about "design for all" when they spend public money. By requiring accessibility in their shopping lists, they make it the standard for the entire market. This helps create a world where accessible products are everywhere, not just in special shops.',
        'In the United States, the Federal Acquisition Regulation (or FAR) does a similar job. It uses the power of the federal government\'s wallet to make sure that the digital tools used by government workers and the public meet high accessibility standards. This is often linked to Section 508 of the Rehabilitation Act, which is a law from 1973 that requires federal technology to be usable by people with disabilities.',
      ],
    },
    {
