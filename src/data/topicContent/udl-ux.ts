  ...
  sections: [
      ...
      subsections: [
        {
          ...
          content: [
            ...
            'To support engagement, instructors should provide options that:<ul class="list-disc ml-6 mt-2 space-y-1"><li>Spark and sustain learners\' interest</li><li>Help learners persist through effort and challenges</li><li>Support self-regulation, including managing emotions, stress, and motivation</li></ul>',
        ...
        },
        {
          ...
          content: [
            ...
            'To support representation, instructors should provide options that:<ul class="list-disc ml-6 mt-2 space-y-1"><li>Present information through multiple sensory modalities (such as text, audio, visuals, and demonstrations)</li><li>Clarify language, symbols, and key concepts</li><li>Support comprehension through structure, scaffolding, and connections between ideas</li></ul>',
        ...
        },
        {
          ...
          content: [
            ...
            'To support action and expression, instructors should provide options that:<ul class="list-disc ml-6 mt-2 space-y-1"><li>Make interaction with tools and environments physically accessible</li><li>Allow different ways to communicate understanding (such as writing, speaking, visual work, or projects)</li><li>Support executive functions through guidance, practice, and scaffolding</li></ul>',
    ...
    },
    {
      ...
      content: [
        ...
        'Key elements of user-centered design include:<ul class="list-disc ml-6 mt-2 space-y-1"><li>Involving users early and throughout the design process through research and testing</li><li>Using iterative cycles of design, feedback, and refinement</li><li>Including accessibility considerations and testing as part of regular design practice</li></ul>',
