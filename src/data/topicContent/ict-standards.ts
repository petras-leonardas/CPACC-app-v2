      ...
      subsections: [
        {
          ...
          content: [
            'The Section 508 of the Rehabilitation Act is a rule that applies specifically to the federal government in the United States. This law is like a rulebook for any technology the government buys or uses.',
            'The Section 508 of the Rehabilitation Act ensures that government employees and the public can use federal tech just as easily as anyone else. This is a "look ahead" kind of law—it means accessibility has to be part of the plan from the very start, whether the government is buying a new computer system or updating its website. To keep things clear, it uses a technical standard called WCAG 2.0.',
            'Section 508 of the Rehabilitation Act is a US law that requires federal agencies to make their electronic technology accessible to people with disabilities.',
            'WCAG 2.0 stands for the Web Content Accessibility Guidelines, which is an international list of "how-to" instructions for making websites accessible.',
        ...
        },
        {
          ...
          content: [
            'The Americans with Disabilities Act of 1990 is a very famous civil rights law that protects people from being treated unfairly. While it was written before the internet was a big part of our lives, the people who look after our laws say it absolutely applies to websites and apps today.',
            'Title III of the Americans with Disabilities Act covers "places of public accommodation." In simple terms, this means any place that serves the public—like an online store, a bank\'s website, or a travel app—must be accessible. If these digital spaces have "virtual stairs" that block people, the owners can find themselves in legal trouble.',
            'The Americans with Disabilities Act is a landmark US civil rights law that prohibits discrimination against people with disabilities in all areas of public life.',
      ...
      subsections: [
        {
          ...
          content: [
            'The European Web Accessibility Directive is a set of rules for public sector bodies, like local councils and government agencies, across the European Union. It says that all their websites and apps must be easy for everyone to use.',
            ...
            'The European Web Accessibility Directive is an EU law that makes it mandatory for public sector websites and apps to be accessible.',
            'EN 301 549 is the specific European technical standard that sets the requirements for accessible ICT products and services.',
        ...
        },
        {
          ...
          content: [
            'The European Accessibility Act is a newer law that moves accessibility beyond just government offices and into the world of private business. Starting in 2025, it will set common rules for many popular products and services.',
            ...
            'The European Accessibility Act is an EU law that requires many private-sector products and services to be accessible to people with disabilities.',
