...
export const ictStandards: DetailedTopicContent = {
  ...
  introduction: [
    'Information and Communication Technology (ICT) has become integral to nearly every aspect of daily life, from education and employment to healthcare, commerce, and civic participation. For decades, accessibility legislation focused primarily on the physical environment, addressing barriers in buildings, transportation, and public spaces. As society has grown increasingly dependent on digital platforms, lawmakers have recognized that an inaccessible website or application can be just as exclusionary as an inaccessible building.',
    'Modern ICT accessibility laws establish digital access as a civil right, not merely a best practice. These laws define which organizations must comply, reference technical standards such as WCAG and EN 301 549 to clarify what compliance means, and prescribe enforcement mechanisms ranging from administrative oversight to private litigation. For CPACC candidates, understanding these legal frameworks is essential because they directly shape how accessibility professionals evaluate, implement, and maintain digital accessibility across both public and private sectors.',
  ],
  learningPoints: [
    'Identify the most important digital accessibility laws in the United States and the European Union.',
    'Understand how technical standards such as WCAG are incorporated into legal requirements.',
    'Recognize which entities are responsible for compliance in both government and private sectors.',
    'Explain how these laws are implemented and enforced.',
  ],
  sections: [
    {
      ...
      subsections: [
        {
          ...
          content: [
            ...
            'To make sure everyone is on the same page, the directive references the European standard known as EN 301 549. If a website follows these rules, it is legally seen as doing a good job.',
        ...
        },
        {
          ...
          content: [
            'The <strong>European Accessibility Act</strong> is a law that moves accessibility beyond government offices and into private business. Since its compliance deadline of June 28, 2025, it sets common rules for many popular products and services across the EU.',
