  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        'Our neighborhoods get stronger when everyone is involved. A community is at its best when it represents many different life experiences. This is a clear example of the <strong>curb-cut effect</strong>: features designed for people with disabilities end up helping everyone. A ramp is not just for a wheelchair user; it is for a parent with a stroller or a delivery person with a heavy cart. Captions on a video are not just for people who are deaf; they help people in a noisy gym or someone learning a new language.'
      ]
    },
    {
