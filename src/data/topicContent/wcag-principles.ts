...
export const wcagPrinciples: DetailedTopicContent = {
  ...
  introduction: [
    ...
    'The gold standard for this is the Web Content Accessibility Guidelines, often called WCAG.',
  ...
  sections: [
    ...
    },
    {
      ...
      content: 'The Web Content Accessibility Guidelines 2.2 uses four main principles to keep us on track. You can remember them with the acronym POUR.',
      subsections: [
        {
