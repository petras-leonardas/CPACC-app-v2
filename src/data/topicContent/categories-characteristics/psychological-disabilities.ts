...
export const psychologicalDisabilities: TopicSection = {
  ...
  content: 'Psychological disabilities affect a person\'s mood, perceptions, thinking, and behavior. These conditions are often <strong>episodic</strong>, meaning they can be managed for long periods but may flare up during times of high stress or in certain environments. Many of these disabilities also affect cognitive functions, like how well a person can focus or make decisions.',
  subsections: [
    {
