...
export const visualDisabilities: TopicSection = {
  ...
  content: 'Visual disabilities cover a huge range of experiences. It is not just about being totally blind; it includes people who see things through a fog, people who are very sensitive to light (photophobia), and people who see colors differently. Some people experience <strong>tunnel vision</strong> where they only see the center of their view, while others might lose their central vision and only see through the edges of their eyes.',
  subsections: [
    {
