...
export const deafBlindness: TopicSection = {
  ...
  content: [
    'This is a unique situation where a person has both hearing and vision loss. It is a rare condition, affecting between 0.2% and 2% of the world\'s population. Because they may not be able to rely on sight or sound from a distance, the sense of touch becomes the primary way they communicate. They navigate their surroundings using touch, smell, and taste to gather information that others get from looking or listening.',
