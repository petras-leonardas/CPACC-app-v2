  ...
  subsections: [
    {
      ...
      content: [
        '<ul class="list-disc ml-6 mt-2 space-y-1><li><strong>Epilepsy</strong> affects approximately <strong>50 million</strong> people globally, making it one of the most common brain-related conditions.</li><li>About <strong>3%</strong> of people with epilepsy have <strong>Photosensitive Epilepsy</strong>, meaning their seizures can be triggered by flashing lights or specific visual patterns.</li><li>Lights that flash between <strong>16 and 25 times per second</strong> are the most likely to cause a reaction in clinical research, though the <strong>WCAG accessibility guidelines set a safer threshold of no more than 3 flashes per second</strong> to protect all users.</li></ul>',
