...
export const interAmericanSystem: TopicSection = {
  ...
  subsections: [
    ...
    {
      heading: 'Making things accessible',
      content: [
        'This convention is very practical about how to fix barriers. It requires countries to look at everything—from buses and buildings to the way the police talk to people—and make sure it is all accessible.',
        'It uses a two-step plan:<ol class="list-decimal ml-6 mt-2 space-y-1"><li><strong>Fix what is already broken:</strong> Countries must work to remove existing obstacles in old buildings or old websites.</li><li><strong>Build it right the first time:</strong> Any new buildings or services must be designed so everyone can use them from day one.</li></ol>'
      ]
    }
  ]
}
