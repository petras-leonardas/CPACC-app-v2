...
export const regionalInstruments: DetailedTopicContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        'Europe has a layered human rights system built over decades. The Charter of Fundamental Rights of the European Union brings together these protections, drawing on earlier European treaties and constitutional traditions. Together, these instruments create comprehensive disability rights protections across Europe.'
      ],
      subsections: [
        {
    ...
    },
    {
      ...
      content: [
        'The Americas were the first region to adopt a binding disability rights treaty. This convention established important precedents for linking non-discrimination with concrete accessibility measures.'
      ],
      subsections: [
        {
