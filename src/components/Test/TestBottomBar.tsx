      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-4 flex flex-row items-center justify-between gap-3">
        ...
        <div className="hidden md:flex flex-shrink-0">
          <button
            ...
            className="px-6 py-3 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:underline transition-colors font-medium"
          >
            {skipButtonText}
          </button>
        </div>
        ...
        <div className="md:hidden flex-shrink-0">
          <button
            onClick={onSkip}
            data-tracking-id="test-skip-question"
            className="px-4 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:underline transition-colors font-medium text-sm"
          >
            {skipButtonText}
          </button>
        </div>
