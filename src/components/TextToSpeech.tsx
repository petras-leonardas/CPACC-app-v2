...
export function TextToSpeech({ content, title, onStateChange }: TextToSpeechProps) {
  ...
  return (
    <div className={`${isActive ? 'sticky top-[104px] z-50 -mt-[25px] md:-mt-[33px] -mx-4 md:-mx-8 px-4 md:px-8 backdrop-blur-md bg-white/70 dark:bg-gray-900/70 border-t' : 'bg-white dark:bg-gray-900 rounded-xl border mb-8'} border-gray-200 dark:border-gray-800 p-4 md:p-6 shadow-sm transition-all duration-300`}>
