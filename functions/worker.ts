...
const HTML_SECURITY_HEADERS: Record<string, string> = {
  ...
  'Content-Security-Policy': [
    ...
    "img-src 'self' data:",
    "font-src 'self'",
    "connect-src 'self' https://api2.amplitude.com https://sr-client-cfg.amplitude.com https://cdn.amplitude.com https://texttospeech.googleapis.com https://challenges.cloudflare.com https://cloudflareinsights.com",
